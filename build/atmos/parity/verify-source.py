...
if not args.inspect_existing:
    ...
    git('am','--3way',str(here.parents[2]/'build/bluray-menu/patches/0011-bluray-retain-navigation-head.patch'))
    git('am','--3way',str(here.parents[2]/'build/bluray-menu/patches/0013-dts-hd-seek-resync.patch'))
    git('am','--3way',str(here.parents[2]/'build/bluray-menu/patches/0014-bluray-slideshow-audio.patch'))
    git('am','--3way',str(here.parents[2]/'build/bluray-menu/patches/0015-native-timing-diagnostics.patch'))
    git('am','--3way',str(here.parents[2]/'build/bluray-menu/patches/0016-secondary-ass-refresh.patch'))
    git('am','--3way',str(here.parents[2]/'build/bluray-menu/patches/0017-secondary-ass-replace.patch'))
    git('am','--3way',str(here.parents[2]/'build/bluray-menu/patches/0018-secondary-ass-idle.patch'))
    git('am','--3way',str(here.parents[2]/'build/bluray-menu/patches/0019-secondary-ass-video-budget.patch'))
    git('am','--3way',str(here.parents[2]/'build/bluray-menu/patches/0020-secondary-ass-video-headroom.patch'))
    git('am','--3way',str(here.parents[2]/'build/bluray-menu/patches/0021-secondary-ass-budget-stability.patch'))
    git('am','--3way',str(here.parents[2]/'build/bluray-menu/patches/0022-native-presentation-telemetry.patch'))
    git('am','--3way',str(here.parents[2]/'build/bluray-menu/patches/0023-native-presentation-reuse.patch'))
    git('am','--3way',str(here.parents[2]/'build/bluray-menu/patches/0024-bluray-popup-atomic-overlay.patch'))
    git('am','--3way',str(here.parents[2]/'build/bluray-menu/patches/0025-bluray-menu-audio-resume.patch'))
    git('am','--3way',str(here.parents[2]/'build/bluray-menu/patches/0026-bluray-popup-fragment-hold.patch'))
    git('am','--3way',str(here.parents[2]/'build/bluray-menu/patches/0027-bluray-menu-audio-diagnostics.patch'))
...
assert git('rev-list','--count','HEAD').strip()=='41'
...
result={'result':'PASS','scope':'fresh exact source + 17 main patches + HDMV video-ready, title/context, late-EL and menu audio queue fixes + 29-patch renderer delta',
